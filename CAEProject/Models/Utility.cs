...
namespace CAEProject.Models
{
    public class Utility
    {
        ...
        static public string SaveUpFile(HttpPostedFileBase upfile)
        {
            ...
            int i = 1;
            while (System.IO.File.Exists(Path.Combine(HttpContext.Current.Server.MapPath("~/upfile/files"), string.Format("{0}.{1}", fileNameTemp, extension))))
            {
            ...
            string savedName = Path.Combine(HttpContext.Current.Server.MapPath("~/upfile/files"), fileName);
        ...
        /// </summary>
        /// <returns></returns>
        public static User GetUserTickets()
        {
        ...
        #region 列舉轉換
        /// <summary>
        /// 傳入列舉值，轉換成DescriptionAttribute中的文字
        /// </summary>
        ...
        #region 生成使用DescriptionAttribute的列舉下拉選單
        /// <summary>
